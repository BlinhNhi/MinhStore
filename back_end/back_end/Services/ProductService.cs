...
namespace back_end.Services
{
    public class ProductService : IProductRepo
    {
        ...
        public static int PAGE_SIZE_SEARCH_PRODUCT { get; set; } = 8;
        ...
        {
            var allProducts = db.Products.Include(ca => ca.Category)
                                          .Include(c => c.Colors)
                                          .Include(s => s.Sizes)
                                          .AsQueryable();
            ...
            allProducts = allProducts.Skip((page - 1) * PAGE_SIZE_EIGHT_PRODUCTS)
                                     .Take(PAGE_SIZE_EIGHT_PRODUCTS);
