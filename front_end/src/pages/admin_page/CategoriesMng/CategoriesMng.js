            ...
            render: (text, cat) => {
                return <>
                    <Button key={1} href={`/admin/categories-mng/edit/${cat.id}`} type="link" icon={<EditOutlined />} onClick={() => {
                        dispatch(getCategoryDetailAction(cat.id))
                    }}></Button>
    ...
    return (
        <div className="text-gray-800 dark:text-gray-200">
            <div className='d-flex mb-4'>
                ...
                <Button href='/admin/categories-mng/addcate' type="primary" className='ml-3 mt-3 small bg-blue-600'>+ Thêm Danh Mục</Button>
            </div>
