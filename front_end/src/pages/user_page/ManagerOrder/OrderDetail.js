...
import { getPaymentDetailAction, getPaymentDetailByUserIdAction } from "../../../redux_store/actions/PaymentAction";
            ...
            <div className="container">
                <div className="py-10">
                    ...
                    <div className="flex flex-col gap-2 sm:gap-1">
                        ...
                        <div className="px-2 flex gap-2 py-3 border-2 border-gray-300 dark:border-gray-100 rounded">
